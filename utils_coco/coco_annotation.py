...
#   指向了COCO训练集与验证集图片的路径
#-------------------------------------------------------#
train_datasets_path     = "A:/coco/train2017"
val_datasets_path       = "A:/coco/val2017"

#-------------------------------------------------------#
#   指向了COCO训练集与验证集标签的路径
#-------------------------------------------------------#
train_annotation_path   = "A:/coco/annotations_train/instances_train2017.json"
val_annotation_path     = "A:/coco/annotations_train/instances_val2017.json"
