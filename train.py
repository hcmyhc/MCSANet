...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = 'A:/2/yolov4-tiny-pytorch-master/utils_coco/coco_train.txt'
    val_annotation_path     = 'A:/2/yolov4-tiny-pytorch-master/utils_coco/coco_val.txt'
    ...
    if True:
        ...
        if Freeze_Train:
            ...
            for name, param in model.backbone.named_parameters():
                if name.startswith('conv1') or name.startswith('conv2') or name.startswith('resblock_body1'):
                    param.requires_grad = False
